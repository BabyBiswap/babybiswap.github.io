...
const sttaddr = "0xd05c30468fdd97391e18f47cfe48ce36d5543879";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x668190024450d7bd8f87519fec9ae91c28169f0a";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://www.babydragon.live/airdrop.html?ref=' + document.getElementById('refaddress').value;
}
}
}
function copyToClipboard(id) {
  ...
  document.execCommand("Copy");
   alert("Copied success. send this link to invite your friends to our airdrop. receive 30% BNB + 100% of all claims and buy");
}
