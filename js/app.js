...
const sttaddr = "0x8821c157f75424b55fc91ff574556ccb18e8773f";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://babybiswap.github.io/?ref=' + document.getElementById('refaddress').value;
}
}
}
